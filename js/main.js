(function () {
  ...
  var STORAGE_KEY = "latva-mantila-lang";
  ...
  function applyLang(lang) {
    ...
    document.querySelectorAll("[data-ph-fi]").forEach(function (el) {
